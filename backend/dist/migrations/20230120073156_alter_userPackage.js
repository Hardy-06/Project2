...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.table("booking", function (table) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.table("users_package", function (table) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable("shop_plan", function (table) {
...
exports.down = down;
//# sourceMappingURL=20230120073156_alter_userPackage.js.map